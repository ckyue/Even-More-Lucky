...
btn.appendChild(t);
var eleMain = document.evaluate( '//*[@id="tsf"]/div[2]/div[3]/center/input[2]' ,document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null ).singleNodeValue; //Feeling lucky
var mainbox = document.evaluate( '//*[@id="tsf"]/div[2]/div[3]/center' ,document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null ).singleNodeValue;
var resultbox = document.evaluate( '//*[@id="sfopt"]' ,document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null ).singleNodeValue;

//-------------------------------------------------------
if (resultbox != null) {
	resultbox.appendChild(btn);
}
												//NEEDS TO BE MODIFIED BY JQUERY
if (mainbox != null) {
